...
function domBuilder() {
    ...
    function createButton(content = null, options = {}) {
        const btnOptions = {
            ...options,
            classes: [
                'db-btn',
        ...
        return createElement(BUTTON, content, btnOptions)
    }
    ...
    function addElement(element, options = null) {
        const insideElement = document.querySelector(options && options.inside || 'section.result')
    ...
    function removeAll() {
        const rootElement = document.querySelector('section.result')
